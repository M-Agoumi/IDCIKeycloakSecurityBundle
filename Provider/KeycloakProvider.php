...
class KeycloakProvider extends AbstractProvider
{
    ...
    {
		$this->protocol = $options['auth_server_protocol'] ?? 'https';
    ...
    {
        return self::MODE_PRIVATE === $mode ?
	        $this->protocol . '://' . $this->authServerPrivateUrl : $this->protocol . '://' .  $this->authServerPublicUrl;
    }
